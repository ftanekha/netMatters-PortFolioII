<div id="choosing-random-color-example-container" class="example">
    ...
    <div class="overal-page-color-theme accordion">
        <img src="../assets/images/code-examples/choosing-random-color-theme.jpeg" class="chestnut"
    ...
    <div class="choosing-the-color-theme-with-code accordion">
        <img src="../assets/images/code-examples/custom-error-message.jpeg" class="chestnut"
            alt="custom error message example" title="custom error message example"
        >
        <img src="../assets/images/code-examples/custom-error-message-vs-js-alert.png" class="chestnut"
    ...
    <div class="choosing-the-color-theme-with-code accordion">
        <img src="../assets/images/code-examples/choosing-random-color-theme-using-bulma-danger.png" 
            alt="using Bulma's danger color" title="using Bulma's danger color" 
        >
        <img src="../assets/images/code-examples/choosing-random-color-theme-using-sass-lighten-function.png" 
